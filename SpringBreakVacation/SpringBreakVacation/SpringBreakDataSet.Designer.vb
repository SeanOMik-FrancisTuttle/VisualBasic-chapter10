...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("SpringBreakDataSet"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class SpringBreakDataSet
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As SpringBreakDataSet = CType(MyBase.Clone,SpringBreakDataSet)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "SpringBreakDataSet"
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/SpringBreakDataSet.xsd"
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As SpringBreakDataSet = New SpringBreakDataSet()
    ...
    Partial Public Class TableDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddTableRow(ByVal firstName As String, ByVal lastName As String, ByVal address As String, ByVal city As String, ByVal state As String, ByVal zip As String, ByVal paid As Decimal) As TableRow
            Dim rowTableRow As TableRow = CType(Me.NewRow,TableRow)
            Dim columnValuesArray() As Object = New Object() {Nothing, firstName, lastName, address, city, state, zip, paid}
    ...
    Partial Public Class TableRow
        ...
        Public Property paid() As Decimal
            Get
                Try 
                    Return CType(Me(Me.tableTable.paidColumn),Decimal)
                Catch e As Global.System.InvalidCastException
                    Throw New Global.System.Data.StrongTypingException("The value for column 'paid' in table 'Table' is DBNull.", e)
                End Try
            End Get
            Set
                Me(Me.tableTable.paidColumn) = value
            End Set
        End Property
        ...
        Public Function IsaddressNull() As Boolean
            Return Me.IsNull(Me.tableTable.addressColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetaddressNull()
            Me(Me.tableTable.addressColumn) = Global.System.Convert.DBNull
        End Sub
        ...
        Public Function IspaidNull() As Boolean
            Return Me.IsNull(Me.tableTable.paidColumn)
        End Function
        
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Sub SetpaidNull()
            Me(Me.tableTable.paidColumn) = Global.System.Convert.DBNull
        End Sub
    End Class
...
Namespace SpringBreakDataSetTableAdapters
    ...
    Partial Public Class TableTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table` WHERE ((`ID` = ?) AND ((? = 1 AND `firstName` IS NULL) OR (`f"& _ 
                ...
                "AND `zip` IS NULL) OR (`zip` = ?)) AND ((? = 1 AND `paid` IS NULL) OR (`paid` = "& _ 
                "?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table` (`firstName`, `lastName`, `address`, `city`, `state`, `zip`, "& _ 
                "`paid`) VALUES (?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table` SET `firstName` = ?, `lastName` = ?, `address` = ?, `city` = ?, `s"& _ 
                "tate` = ?, `zip` = ?, `paid` = ? WHERE ((`ID` = ?) AND ((? = 1 AND `firstName` I"& _ 
                ...
                ") AND ((? = 1 AND `zip` IS NULL) OR (`zip` = ?)) AND ((? = 1 AND `paid` IS NULL)"& _ 
                " OR (`paid` = ?)))"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.SpringBreakVacation.My.MySettings.Default.SpringBreakConnectionString
        End Sub
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID, firstName, lastName, address, city, state, zip, paid FROM [Table]"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As SpringBreakDataSet.TableDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As SpringBreakDataSet.TableDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As SpringBreakDataSet.TableDataTable = New SpringBreakDataSet.TableDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As SpringBreakDataSet.TableDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As SpringBreakDataSet) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_firstName As String, ByVal Original_lastName As String, ByVal Original_address As String, ByVal Original_city As String, ByVal Original_state As String, ByVal Original_zip As String, ByVal Original_paid As Global.System.Nullable(Of Decimal)) As Integer
            ...
            If (Original_paid.HasValue = true) Then
                ...
                Me.Adapter.DeleteCommand.Parameters(14).Value = CType(Original_paid.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Insert(ByVal firstName As String, ByVal lastName As String, ByVal address As String, ByVal city As String, ByVal state As String, ByVal zip As String, ByVal paid As Global.System.Nullable(Of Decimal)) As Integer
            ...
            If (paid.HasValue = true) Then
                Me.Adapter.InsertCommand.Parameters(6).Value = CType(paid.Value,Decimal)
            Else
        ...
        Public Overloads Overridable Function Update(ByVal firstName As String, ByVal lastName As String, ByVal address As String, ByVal city As String, ByVal state As String, ByVal zip As String, ByVal paid As Global.System.Nullable(Of Decimal), ByVal Original_ID As Integer, ByVal Original_firstName As String, ByVal Original_lastName As String, ByVal Original_address As String, ByVal Original_city As String, ByVal Original_state As String, ByVal Original_zip As String, ByVal Original_paid As Global.System.Nullable(Of Decimal)) As Integer
            If (firstName Is Nothing) Then
            ...
            End If
            If (paid.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(paid.Value,Decimal)
            Else
            ...
            If (Original_paid.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(21).Value = CType(Original_paid.Value,Decimal)
            Else
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As SpringBreakDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As SpringBreakDataSet, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._tableTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As SpringBreakDataSet, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._tableTableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As SpringBreakDataSet) As Integer
